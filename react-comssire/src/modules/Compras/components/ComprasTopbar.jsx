    ...
    <header className="app-topbar px-4 py-3 md:px-5">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between w-full">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            onClick={onScan}
            className="px-4 py-2.5 text-sm bg-white/10 hover:bg-white/15 text-slate-100 rounded-2xl flex items-center gap-2 border border-white/10 transition-colors shadow-none"
          >
